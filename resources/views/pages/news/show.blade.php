...
<!-- Detail Berita -->
  <div class="flex flex-col px-4 lg:px-14 mt-10">
    ...
    <div class="lg:w-8/12">
        ...
        <article class="mt-5 font-semibold teleading-relaxed">
              ...
              <div class="flex gap-3 border border-slate-300 hover:border-primary p-3 rounded-xl">
                ...
                <div class="flex gap-3 flex-col lg:flex-row">
                  ...
                  <div class="">
                    ...
                    <p class="text-slate-400 mt-2 text-sm lg:text-xs"><p class="text-slate-400 mt-2 text-sm lg:text-xs leading-relaxed">
  ...
  <div class="flex flex-col gap-4 mb-10 p-4 lg:p-10 lg:px-14 w-full lg:w-2/3">
    ...
    <a href="{{ route('author.show', $news->    author->username) }}" class="block">
      <div
